...
void draw_ratio() {
    ...
    c1->cd(2);
    {
        ...
        TH1D* hist_all_toward = getCentPtProjectionsAll(filename, histname1);
        TH1D* hist_all_transverse = getCentPtProjectionsAll(filename, histname2);
        TH1D* hist_all = createRatioHistogram(hist_all_toward, hist_all_transverse, "hist_all_ratio_k");
        TGraphErrors* graph_all = drawConnectedPoints(hist_all, colors[0], markerStyles[0]);
        graph_all->Draw("LP");
    ...
    c1->cd(3);
    {
        ...
        TH1D* hist_all_toward = getCentPtProjectionsAll(filename, histname1);
        TH1D* hist_all_transverse = getCentPtProjectionsAll(filename, histname2);
        TH1D* hist_all = createRatioHistogram(hist_all_toward, hist_all_transverse, "hist_all_ratio_p");
        TGraphErrors* graph_all = drawConnectedPoints(hist_all, colors[0], markerStyles[0]);
        graph_all->Draw("LP");
