...
TGraphErrors* drawConnectedPoints(TH1D* hist, Color_t color, Style_t markerStyle) {
    ...
    for (int i = 1; i <= n; ++i) {
        ...
        if (binCenter>0.15 && binCenter < 5) { // 只保留 x < 3 的点
            x[count] = binCenter;
...
void addText2(Double_t x, Double_t y, const char* text) {
    TLatex* latex = new TLatex(x, y, text);
    latex->SetNDC(kTRUE);  // 将坐标转换为百分比
    latex->SetTextSize(0.055);  // 设置字体大小
    latex->Draw();
}
...
std::vector<TH1D*> getCentPtProjections(const TString& filename, const TString& histname) {
    ...
    double averageNT = chargedParticlesCount->GetMean();  // 计算加权平均NT
    cout<<"averageNT: "<<averageNT<<" "<<totalChargedParticles/nEvents<<endl;
...
//    double rtUpperRanges[2] = {0.5,5.0};  // RT 上限
...
void drawLog04(){
  ...
  // ================ 第一行：K/π ================
  // TH2D *axisFrame1 = new TH2D("axisFrame1", "; ; ", 100, -0.1, 3.1, 100,  0.01, 0.38);
  ...
  //TString filename1 = "hist_outputnoFSI_SQ0.9_CQ1.4_BQ1.2.root"; 
  //TString filename1 = "hist_outputnoFSI_old.root"; 
  TString filename1 = "hist_outputnoFSI_all.root"; 
  //TString filename1 = "hist_outputnoFSI_CQ1.4_BQ1.2.root"; 
  // 第一子图 (K/π, no FSI)
  {
      c1->cd(1);
      gPad->SetTicks(1,1);
  ...
  axisFrame1->GetYaxis()->SetLabelSize(0.075);
      ...
      label1->DrawLatexNDC(0.05, 0.44, "K/#pi");
      addText3(0.66, 0.90, "0mb w/o ART");
      addText3(0.24, 0.90, "In-Jet");
      //TString filename1 = "hist_outputnoFSI_more.root"; 
...
//      for (auto& hist : projections4_1) hist->Rebin(rebinFactor1);
      for (auto& hist : projections1_1) hist=(TH1D*)hist->Rebin(9, "hnew1", binEdge);
      for (auto& hist : projections2_1) hist=(TH1D*)hist->Rebin(9, "hnew2", binEdge);
      for (auto& hist : projections3_1) hist=(TH1D*)hist->Rebin(9, "hnew3", binEdge);
      for (auto& hist : projections4_1) hist=(TH1D*)hist->Rebin(9, "hnew4", binEdge);
  ...
  //TString filename2 = "hist_outputnohFSI_SQ0.9_HQ1.4.root"; 
  TString filename2 = "hist_outputnohFSI_all.root"; 
  {
      c1->cd(2);
      gPad->SetTicks(1,1);
  TH2D *axisFrame2 = new TH2D("axisFrame2", "; ; ", 100, -0.1, 3.1, 100,  0.01, 0.38);
  axisFrame2->GetYaxis()->SetTickLength(0.02);
  axisFrame2->GetXaxis()->SetTickLength(0.02);
  axisFrame2->GetXaxis()->SetLabelSize(0.075);
  axisFrame2->GetYaxis()->SetLabelSize(0.075);
      axisFrame2->Draw("axis");

      addText3(0.51, 0.90, "0.15mb w/o ART");
...
//      for (auto& hist : projections4_2) hist->Rebin(rebinFactor2);
      for (auto& hist : projections1_2) hist=(TH1D*)hist->Rebin(9, "hnew1", binEdge);
      for (auto& hist : projections2_2) hist=(TH1D*)hist->Rebin(9, "hnew2", binEdge);
      for (auto& hist : projections3_2) hist=(TH1D*)hist->Rebin(9, "hnew3", binEdge);
      for (auto& hist : projections4_2) hist=(TH1D*)hist->Rebin(9, "hnew4", binEdge);
  ...
  // 第三子图 (K/π, all FSI)
  //TString filename3 = "hist_outputallFSI_old.root"; 
  TString filename3 = "hist_outputallFSI_all.root"; 
  {
      c1->cd(3);
      gPad->SetTicks(1,1);
      gPad->SetRightMargin(0.01);
  TH2D *axisFrame3 = new TH2D("axisFrame3", "; ; ", 100, -0.1, 3.1, 100,  0.01, 0.38);
  axisFrame3->GetYaxis()->SetTickLength(0.02);
  axisFrame3->GetXaxis()->SetTickLength(0.02);
  axisFrame3->GetXaxis()->SetLabelSize(0.075);
  axisFrame3->GetYaxis()->SetLabelSize(0.075);
      axisFrame3->Draw("axis");

      addText3(0.54, 0.90, "0.15mb w/ ART");
...
//      for (auto& hist : projections4_3) hist->Rebin(rebinFactor3);
      ...
      for (auto& hist : projections1_3) hist=(TH1D*)hist->Rebin(9, "hnew1", binEdge);
      for (auto& hist : projections2_3) hist=(TH1D*)hist->Rebin(9, "hnew2", binEdge);
      for (auto& hist : projections3_3) hist=(TH1D*)hist->Rebin(9, "hnew3", binEdge);
      for (auto& hist : projections4_3) hist=(TH1D*)hist->Rebin(9, "hnew4", binEdge);
  ...
  // ================ 第二行：p/π ================
      // TH2D *axisFrame4 = new TH2D("axisFrame4", "; ; ", 100, -0.1, 3.1, 100,  0, 0.26);
  ...
  // 第四子图 (p/π, no FSI)
  {
      ...
      //TString filename4 = "hist_outputnoFSI_all.root"; 
      ...
      std::vector<TH1D*> projections1_4 = getCentPtProjections(filename1, histname1_4);
      std::vector<TH1D*> projections2_4 = getCentPtProjections(filename1, histname2_4);
      std::vector<TH1D*> projections3_4 = getCentPtProjections(filename1, histname3_4);
      std::vector<TH1D*> projections4_4 = getCentPtProjections(filename1, histname4_4);
...
//      for (auto& hist : projections4_4) hist->Rebin(rebinFactor4);
      ...
      for (auto& hist : projections1_4) hist=(TH1D*)hist->Rebin(9,"hnew1",binEdge);
      for (auto& hist : projections2_4) hist=(TH1D*)hist->Rebin(9,"hnew2",binEdge);
      for (auto& hist : projections3_4) hist=(TH1D*)hist->Rebin(9,"hnew3",binEdge);
      for (auto& hist : projections4_4) hist=(TH1D*)hist->Rebin(9,"hnew4",binEdge);
  ...
  // 第五子图 (p/π, no hadronic FSI)
  {
      c1->cd(5);
      gPad->SetTicks(1,1);
      TH2D *axisFrame5 = new TH2D("axisFrame5", "; ; ", 100, -0.1, 3.1, 100,  0, 0.26);
      ...
      //TString filename5 = "hist_outputnohFSI_all.root"; 
...
text2->Draw();
      ...
      std::vector<TH1D*> projections1_5 = getCentPtProjections(filename2, histname1_5);
      std::vector<TH1D*> projections2_5 = getCentPtProjections(filename2, histname2_5);
      std::vector<TH1D*> projections3_5 = getCentPtProjections(filename2, histname3_5);
      std::vector<TH1D*> projections4_5 = getCentPtProjections(filename2, histname4_5);
...
//      for (auto& hist : projections4_5) hist->Rebin(rebinFactor5);
      ...
      for (auto& hist : projections1_5) hist=(TH1D*)hist->Rebin(9,"hnew1",binEdge);
      for (auto& hist : projections2_5) hist=(TH1D*)hist->Rebin(9,"hnew2",binEdge);
      for (auto& hist : projections3_5) hist=(TH1D*)hist->Rebin(9,"hnew3",binEdge);
      for (auto& hist : projections4_5) hist=(TH1D*)hist->Rebin(9,"hnew4",binEdge);
  ...
  // 第六子图 (p/π, all FSI)
  {
      ...
      gPad->SetTicks(1,1);
      gPad->SetRightMargin(0.01);
      TH2D *axisFrame6 = new TH2D("axisFrame6", "; ; ", 100, -0.1, 3.1, 100,  0, 0.26);
      ...
      //TString filename6 = "hist_outputallFSI_all.root"; 
      ...
      std::vector<TH1D*> projections1_6 = getCentPtProjections(filename3, histname1_6);
      std::vector<TH1D*> projections2_6 = getCentPtProjections(filename3, histname2_6);
      std::vector<TH1D*> projections3_6 = getCentPtProjections(filename3, histname3_6);
      std::vector<TH1D*> projections4_6 = getCentPtProjections(filename3, histname4_6);
...
//      for (auto& hist : projections4_6) hist->Rebin(rebinFactor6);
      ...
      for (auto& hist : projections1_6) hist=(TH1D*)hist->Rebin(9, "hnew1", binEdge);
      for (auto& hist : projections2_6) hist=(TH1D*)hist->Rebin(9, "hnew2", binEdge);
      for (auto& hist : projections3_6) hist=(TH1D*)hist->Rebin(9, "hnew3", binEdge);
      for (auto& hist : projections4_6) hist=(TH1D*)hist->Rebin(9, "hnew4", binEdge);
  ...
  c1->SaveAs("K_and_P_hadd04_rebin.png");
  c1->SaveAs("K_and_P_hadd04_rebin.pdf");
}
