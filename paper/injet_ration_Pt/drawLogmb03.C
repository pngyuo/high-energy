...
void drawLogmb03(){
  ...
  // 第一子图 (K/π, no FSI)
  {
      ...
      addText3(0.60, 0.90, "0.10mb w/o ART");
      addText3(0.24, 0.90, "In-Jet");
      TString filename1 = "hist_outputnohFSI_01mb.root"; 
      ...
      for (auto& hist : projections1_1) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor1);
}
      for (auto& hist : projections2_1) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor1);
}
      for (auto& hist : projections3_1) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor1);
}
     for (auto& hist : projections4_1) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor1);
}
  ...
  // 第二子图 (K/π, no hadronic FSI)
  {
      ...
      addText3(0.52, 0.90, "0.15mb w/o ART");
      ...
      for (auto& hist : projections1_2) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor2);
}
      for (auto& hist : projections2_2) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor2);
}
      for (auto& hist : projections3_2) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor2);
}
     for (auto& hist : projections4_2) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor2);
}
  ...
  // 第三子图 (K/π, all FSI)
  {
      ...
      addText3(0.51, 0.90, "0.20mb w/o ART");

      TString filename3 = "hist_outputnohFSI_02mb.root"; 
      ...
      for (auto& hist : projections1_3) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor3);
}
      for (auto& hist : projections2_3) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor3);
}
      for (auto& hist : projections3_3) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor3);
}
     for (auto& hist : projections4_3) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor3);
}
  ...
  // 第四子图 (p/π, no FSI)
  {
      c1->cd(4);
      gPad->SetTicks(1,1);
      TH2D *axisFrame4 = new TH2D("axisFrame4", "; ; ", 100, -0.1, 3.1, 100,  0, 0.19);
      ...
      TString filename4 = "hist_outputnohFSI_01mb.root"; 
      ...
      for (auto& hist : projections1_4) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor4);
}
      for (auto& hist : projections2_4) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor4);
}
      for (auto& hist : projections3_4) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor4);
}
     for (auto& hist : projections4_4) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor4);
}
  ...
  // 第五子图 (p/π, no hadronic FSI)
  {
      c1->cd(5);
      gPad->SetTicks(1,1);
      TH2D *axisFrame5 = new TH2D("axisFrame5", "; ; ", 100, -0.1, 3.1, 100,  0, 0.19);
...
text2->Draw();
      ...
      for (auto& hist : projections1_5) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor5);
}
      for (auto& hist : projections2_5) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor5);
}
      for (auto& hist : projections3_5) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor5);
}
     for (auto& hist : projections4_5) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor5);
}
  ...
  // 第六子图 (p/π, all FSI)
  {
      ...
      gPad->SetTicks(1,1);
      gPad->SetRightMargin(0.01);
      TH2D *axisFrame6 = new TH2D("axisFrame6", "; ; ", 100, -0.1, 3.1, 100,  0, 0.19);
      ...
      TString filename6 = "hist_outputnohFSI_02mb.root"; 
      ...
      for (auto& hist : projections1_6) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor6);
}
      for (auto& hist : projections2_6) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor6);
}
      for (auto& hist : projections3_6) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor6);
}
     for (auto& hist : projections4_6) {
    hist = (TH1D*)rebinHistogramThreshold(hist, 2.5, rebinFactor6);
}
  ...
  c1->SaveAs("K_and_P_mb03.png");
  c1->SaveAs("K_and_P_mb03.pdf");
}