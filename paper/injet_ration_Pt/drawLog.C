...
void drawLog(){
  ...
  // 第四子图 (p/π, no FSI)
  {
      c1->cd(4);
      gPad->SetTicks(1,1);
      TH2D *axisFrame4 = new TH2D("axisFrame4", "; ; ", 100, -0.1, 3.1, 100,  0, 0.33);
      ...
      TString filename4 = "hist_outputnoFSI_more.root"; 
  ...
  // 第五子图 (p/π, no hadronic FSI)
  {
      c1->cd(5);
      gPad->SetTicks(1,1);
      TH2D *axisFrame5 = new TH2D("axisFrame5", "; ; ", 100, -0.1, 3.1, 100,  0, 0.33);
  ...
  // 第六子图 (p/π, all FSI)
  {
      ...
      gPad->SetTicks(1,1);
      gPad->SetRightMargin(0.01);
      TH2D *axisFrame6 = new TH2D("axisFrame6", "; ; ", 100, -0.1, 3.1, 100,  0, 0.33);
  ...
  c1->SaveAs("K_and_P_hadd.png");
  c1->SaveAs("K_and_P_hadd.pdf");
}