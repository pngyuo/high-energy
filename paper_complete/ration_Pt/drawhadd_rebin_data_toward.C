...
void drawhadd_rebin_data_toward() {
    ...
    TFile *file = TFile::Open("output_histograms_toward.root", "READ");
    ...
    // 第一列：K/π (noFSI)
    {
        ...
        TString filenames1= "k_pi_ratio_toward_255.root";
    ...
    // 第二列：K/π (nohFSI)
    {
        c1->cd(2);
        gPad->SetTicks(1, 1);
        TH2D *axisFrame2 = new TH2D("axisFrame2", "; ; ", 100, -0.1, 2.99, 100, 0.01, 0.43);
    ...
    // 第三列：K/π (allFSI)
    {
        ...
        TH2D *axisFrame3 = new TH2D("axisFrame3", "; ; ", 100, -0.1, 2.99, 100,0.01, 0.43);
    ...
    // 第四列：p/π (noFSI)
    {
        ...
        TString filenames1= "p_pi_ratio_toward_255.root";
        TFile* infile2 = new TFile(filenames1, "READ");
        TGraphErrors *graph2 = (TGraphErrors*)infile2->Get("Pt");
        graph2->SetMarkerStyle(24);
        graph2->SetMarkerSize(1.3);
    ...
    c1->SaveAs("pi_k_p_toward_hadd_rebin_new_data.png");
    c1->SaveAs("pi_k_p_toward_hadd_rebin_new_data.pdf");
}