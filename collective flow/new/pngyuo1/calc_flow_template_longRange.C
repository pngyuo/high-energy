...
//	TH1D *htmp2 = (TH1D*)hin->ProjectionX("htmp2", hin->GetYaxis()->FindBin(2), hin->GetNbinsY());
	...
	TH1D *htmp1 = (TH1D*)hin->ProjectionX("htmp1", hin->GetYaxis()->FindBin(-12.0), hin->GetYaxis()->FindBin(-5.0));
	TH1D *htmp2 = (TH1D*)hin->ProjectionX("htmp2", hin->GetYaxis()->FindBin(5.0), hin->GetYaxis()->FindBin(12.0));
