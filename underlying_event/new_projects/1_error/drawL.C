...
void drawL(){
  ...
  c1->cd(3)->SetLeftMargin(0);
    ...
    TString histname[3] = {"pLAvgPt_NT0_ptcut", "pLAvgPt_NT2_ptcut", "pLAvgPt_NT1_ptcut"};
    ...
    for (int j = 0; j < 3; j++) {
        ...
        TH2D *axisFrame = new TH2D("axisFrame", "; ; ", 100, -0.1, 5.1, 100, 0.5, 2.5);
