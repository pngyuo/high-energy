...
void drawLc(){
  ...
  c1->cd(3)->SetLeftMargin(0);
    ...
    TString histname[3] = {"pLcAvgPt_NT0_ptcut", "pLcAvgPt_NT2_ptcut", "pLcAvgPt_NT1_ptcut"};
    ...
    for (int j = 0; j < 3; j++) {
        ...
        TH2D *axisFrame = new TH2D("axisFrame", "; ; ", 100, -0.1, 5.1, 100, 0, 5);
