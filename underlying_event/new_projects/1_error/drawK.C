...
void drawK(){
  ...
  c1->cd(3)->SetLeftMargin(0);
    ...
    TString histname[3] = {"pKAvgPt_NT0_ptcut", "pKAvgPt_NT2_ptcut", "pKAvgPt_NT1_ptcut"};
    TString filenames1[3]= {"K_toward.root", "K_away.root", "K_transverse.root"};
    ...
    for (int j = 0; j < 3; j++) {
        ...
        TH2D *axisFrame = new TH2D("axisFrame", "; ; ", 100, -0.1, 5.1, 100, 0.5, 1.5);
