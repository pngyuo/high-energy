...
TString filenames1="p.pi.root";
  ...
  std::vector<TH1D*> projections2 = getCentPtProjections(filename[i], histname2);
   std::vector<TH1D*> projections3 = getCentPtProjections(filename[i], histname3);
  std::vector<TH1D*> projections4 = getCentPtProjections(filename[i], histname4);
