...
void drawP() {
  ...
  TString histname3 = "hPiCh_dPhi1"; 
  //TString histname4 = "hProton_dPhi1"; 
  ...
  gStyle->SetOptStat(kFALSE);
     ...
     std::vector<TH1D*> projection2 = getCentPtProjections(filenames, histname3); // 获取投影
    drawGraphs(gPad,projection1,projection2,colors, markerStyles);
  ...
  addText2(0.35, 0.8, "Transverse   nohFSI");
 //c1->SetLogy(); // 设置y轴为对数刻度
  c1->SaveAs("nohFSI.png");
}