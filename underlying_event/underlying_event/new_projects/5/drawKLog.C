...
void drawKLog(){
  TCanvas *c1 = new TCanvas("c1", "c1", 400, 600); // 创建Canvas
...
addText2(0.45, 0.85, "InJet");
  ...
  TLegend *legend1 = new TLegend(0.15, 0.67, 0.38,0.85);
  ...
  gPad->SetRightMargin(0.05); // 减小右侧边距
  TH2D *axisFrame2 = new TH2D("axisFrame2", "; ; ", 100, -0.1, 5.1, 100, 0, 2); // Y轴范围调整为0到2
  axisFrame2->GetYaxis()->SetTickLength(0.02); // 调整刻度长度
  axisFrame2->GetXaxis()->SetTickLength(0.02);
  axisFrame2->Draw("axis");
  TPaveText *text2 = new TPaveText(0.425, 0, 0.575, 0.06, "NDC");
