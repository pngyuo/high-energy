  ...
  void calc_flow_fn_longRange() {
    ...
    for (int icent = 1; icent < N_cent; icent++) {
        ...
        for (int iEta = 0; iEta < nEtaBins; iEta++) {
            ...
            hsame_centlow->GetZaxis()->SetRange(zBinmin, zBinmax);
            hmixed_centlow->GetZaxis()->SetRange(zBinmin, zBinmax);
            hsame_cent[icent]->GetZaxis()->SetRange(zBinmin, zBinmax);
            hmixed_cent[icent]->GetZaxis()->SetRange(zBinmin, zBinmax);
    ...
    TLegend *leg = new TLegend(0.15,0.25,0.15,0.25);
    leg->SetBorderSize(0);
