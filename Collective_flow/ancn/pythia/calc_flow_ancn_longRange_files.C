...
void processFile(const char* fileName, const char* fileLabel, TFile* outfile, 
    ...
    for (int iEta = 0; iEta < nEtaBins; iEta++) {
        ...
        etaValues[iEta] = eta;
        int zBinmin = 2*iEta + 16;
        int zBinmax = 2*iEta + 17;
...
void calc_flow_ancn_longRange_files() {
    ...
    const char* fileLabels[4] = {"pythia", "normal_0.15mb", "normal_1.5mb_a08_b04","normal_0.15mb_a08_b04"};
    const char* legendLabels[4] = {"pythia", "normal 0.15mb", "normal 1.5mb a=0.8 b=0.4", "normal 0.15mb a=0.8 b=0.4"};
