...
void calc_flow_ancn_longRange_files03() {
    ...
    const char* fileLabels[4] = {"3q_0.15mb","3q_1.5mb", "normal_1.5mb_a08_b04","normal_0.15mb_a08_b04"};
    const char* legendLabels[4] = {"3q 0.15mb","3q 1.5mb","normal 1.5mb a=0.8 b=0.4", "normal 0.15mb a=0.8 b=0.4"};
