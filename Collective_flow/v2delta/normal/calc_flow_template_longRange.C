...
void calc_flow_template_longRange_new(){
	TFile *file_1 = new TFile("hist_ampt_normal_1.5mb_longRange_yuhao.root");
	TFile *file_2 = new TFile("hist_ampt_normal_1.5mb_longRange_yuhao.root");
  //TPCFMD12
  ...
  if (v22FMD12FMD3 != 0) {
	...
	TFile *infile_Pid_Low = new TFile("hist_ampt_normal_1.5mb_longRange_yuhao.root");
	TFile *infile_Pid_High = new TFile("hist_ampt_normal_1.5mb_longRange_yuhao.root");
