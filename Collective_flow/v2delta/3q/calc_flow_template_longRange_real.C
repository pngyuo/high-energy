...
void calc_flow_template_longRange_real(){
  ...
  TString filenames[3] = {
    "hist_ampt_3q_1.5mb_longRange_yuhao.root",
    "hist_ampt_3q_0.15mb_longRange_yuhao.root", 
    "hist_ampt_normal_1.5mb_a_0.8_b_0.4_Decorr_yuhao.root"
  };
  
  TString labels[3] = {"3q_1.5mb", "3q_0.15mb", "normal_1.5mb_a0.8_b0.4"};
  ...
  TH2D *hframe_Nch = new TH2D("hframe_Nch", ";N_{ch};v_{2}{2}", 100, 0, 80, 100, 0, 0.0032);
  hframe_Nch->Draw();
  
  TLegend *leg_Nch = new TLegend(0.15, 0.7, 0.3, 0.85);
  ...
  TH2D *hframe_pt = new TH2D("hframe_pt", ";p_{T} (GeV/c);v_{2}", 100, 0, 4, 100, 0, 0.0082);
  hframe_pt->Draw();
